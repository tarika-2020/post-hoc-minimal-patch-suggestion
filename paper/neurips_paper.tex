...
\citep{tau_style,web_arena,work_arena,swe_bench,reflexion,self_refine,tree_of_thoughts}.
...
model-backed proposal ablations, verify and finalize the bibliography, and
produce camera-ready figures directly from saved JSON artifacts.
