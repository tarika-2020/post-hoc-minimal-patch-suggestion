...
baseline recovers $15/80$ natural failures. On the synthetic corpus, heuristic
localization recovers $24/24$ with perfect top-1 localization. These results motivate
...
Recent benchmarks such as $\tau$-style environments, WebArena, WorkArena,
...
The closest related work is REFLECT, which also uses intervention-supported
