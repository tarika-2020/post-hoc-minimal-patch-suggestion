...
about continuation quality than fault localization alone.
...
\begin{tabular}{lrrrr}
\toprule
Method & Recov. & SRR & Tokens & Med. cost \\
\midrule
...
release. The current natural recoveries are dominated by deletion-style local
repairs, which helps explain why airline benefits more than retail under the
present workshop method.}
